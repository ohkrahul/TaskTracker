...
import Register from './components/Register';
import TaskDashboard from './components/TaskDashboard';
import TaskDetails from './components/TaskDetails'; // New component for task details
        ...
        <div className="container mx-auto px-4 py-8 w-full max-w-6xl">
          <Routes>
            ...
            <Route
              ...
              element={user ? <TaskDashboard user={user} /> : <Navigate to="/login" />}
            />
            {/* New routes for task list and details */}
            <Route
              path="/tasks"
              element={user ? <TaskDashboard user={user} /> : <Navigate to="/login" />}
            />
            ...
            <Route
              ...
              element={user ? <TaskDashboard user={user} filter={true} /> : <Navigate to="/login" />}
            />
          </Routes>
        </div>
      </div>
